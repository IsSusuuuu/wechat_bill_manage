...
# 检查JAR文件
if [ -f "target/MoneyManageSystem-0.0.1-SNAPSHOT.jar" ]; then
    JAR_FILE="target/MoneyManageSystem-0.0.1-SNAPSHOT.jar"
elif [ -f "app/MoneyManageSystem-0.0.1-SNAPSHOT.jar" ]; then
    JAR_FILE="app/MoneyManageSystem-0.0.1-SNAPSHOT.jar"
elif [ -f "MoneyManageSystem-0.0.1-SNAPSHOT.jar" ]; then
    JAR_FILE="MoneyManageSystem-0.0.1-SNAPSHOT.jar"
else
